...
RUN sudo chown -R coder:coder /home/coder/.local && sudo chmod +x /usr/bin/container-entrypoint.sh \
...
RUN pip3 install pylint flake8 autopep8 pydocstyle pycodestyle powerline-shell
